    ...
    <>
        ...
        <div className="sector-1 flex items-center flex-col gap-8 md:gap-0 lg:flex-row">
          <div className="text">
            <WaterText
              ...
              className="ps-6 comfortaa-700 text-center md:text-left text-6xl md:text-[10rem] mb-6 md:mb-0"
            />
      ...
      <section id="projects" className="flex justify-center px-10 py-11">
        <div className="relative">
          <div className="gallery w-[90vw] h-[90vh] bg-white/20 backdrop-blur-xl rounded-4xl shadow-[inset_4px_4px_8px_rgba(255,255,255,0.1),inset_-4px_-4px_8px_rgba(255,255,255,0.08),0_8px_20px_rgba(0,0,0,0.2)] gradient-outline before:rounded-4xl grid grid-cols-4 grid-rows-1 gap-6 pt-8 pb-16 px-10 ring-6 ring-white/30">
            <div className="gallery-card relative p-4 bg-white/30 rounded-lg gradient-outline before:rounded-lg">
              <div className="content bg-white/30 rounded-lg w-full h-full p-4 flex flex-col gap-4 relative gradient-outline before:rounded-lg">
                <img
                ...
                className="w-[100%] rounded-2xl ring-2 ring-white/40 transition-all duration-700 hover:blur"
                />
                ...
                <hr />
                <div className="cta flex gap-4 flex-wrap justify-around">
              ...
              {/* <span className="project-type absolute text-white bg-white/20 rounded-xl rounded-tr-4xl p-1 backdrop-blur-2xl top-0 right-0 -translate-y-[11px] translate-x-[13px] shadow-[inset_4px_4px_8px_rgba(255,255,255,0.3),inset_-4px_-4px_8px_rgba(255,255,255,0.28)]">
                <svg width="27" height="27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="white-gradient" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stop-color="#3D3D3DB4"/>
                    <stop offset="50%" stop-color="#20202078"/>
                    <stop offset="100%" stop-color="#170E0E64"/>
                    </linearGradient>
                  </defs>
              ...
              <div className="more-info absolute bottom-0 left-0 px-5 py-2 min-w-50 rounded-bl-lg rounded-tr-4xl bg-white/30 inset-ring-2 inset-ring-white/20 shadow-[inset_2px_2px_3px_rgba(255,255,255,0.4),inset_-2px_-2px_3px_rgba(255,255,255,0.25)]">
